...
import { deletetTablet, getTablet } from "./api";
...
try {
  ...
  const result=await deletetTablet(id)
  ...
  return (
    <Container className="py-4">
      <h2 className="text-center mb-4">Tablets</h2>
      ...
      <Row>
        {products.length > 0 ? (
          ...
          !loading && <h5 className="text-center w-100">No products found.</h5>
        )}
      </Row>
    </Container>
  );
